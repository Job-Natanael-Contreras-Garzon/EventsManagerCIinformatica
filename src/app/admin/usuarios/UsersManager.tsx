...
import { createUserAction, logoutAction } from "@/modules/auth/actions/auth.actions";
      ...
      <header className="sticky top-0 z-40 w-full max-w-lg bg-brand-navy/80 backdrop-blur-md border-b border-brand-blue/35 px-4 py-3 flex flex-col gap-2.5 sm:flex-row sm:items-center sm:justify-between">
        <div className="flex items-center justify-between">
          ...
          <div className="sm:hidden">
            <form action={logoutAction}>
              <button
                type="submit"
                className="text-xs font-semibold text-zinc-400 hover:text-zinc-200 transition-colors min-h-[44px] flex items-center px-2 cursor-pointer"
              >
                Salir
              </button>
            </form>
        ...
        <div className="flex items-center justify-between sm:justify-end gap-3 border-t border-brand-blue/20 pt-2 sm:border-0 sm:pt-0">
          ...
          <form action={logoutAction} className="hidden sm:block">
            <button
              type="submit"
              className="inline-flex items-center justify-center px-3 py-1.5 rounded-lg text-xs font-semibold text-brand-sky/75 hover:text-white bg-brand-dark/65 border border-brand-blue/30 hover:bg-brand-blue/40 active:scale-95 transition-all min-h-[32px] cursor-pointer"
            >
              Cerrar Sesión
            </button>
          </form>
